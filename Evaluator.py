...
def generate_piece_location_worth(side: Side, pieceType: PieceType, boardIndex: int):

    pt = piece_tables[pieceType]
    if side is Side.BLACK:
        pt = pt[::-1]
    return pt[boardIndex]

def evaluate_board(board: list[IPiece]):
    total_worth = 0
